    ...
    >
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" size="medium" @click="addphoto"
            >确 定</el-button
          >
        </span>
      </el-dialog>
      <header>
        ...
        <span class="three"
          >{{ $route.query.data.answername || userchatinfo.name }}
        </span>
      </header>
      <div class="content" v-for="(item, index) in chatlist" :key="index">
        ...
        <div v-else class="item item-left">
          <div class="avatar"><img :src="avatar || userchatinfo.avatar" /></div>
    ...
    send() {
      if (this.content == "") {
        ...
        let chat = {
          ...
          answerid:
            this.$route.query.data.answerid || this.userchatinfo.adminid,
