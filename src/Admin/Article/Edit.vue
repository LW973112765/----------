...
export default {
  ...
  mounted() {
    ...
    // console.log("编辑", typeof this.$route.query.tag);
  ...
  methods: {
    ...
    //     if (res.data.status === 200) {
    //       console.log("ididi", res.data.data[0].name);
    //       this.ruleForm.tag = res.data.data[0].name;
    //     }
    //   });
    //   console.log("灌灌灌灌", this.ruleForm.tag);
    // },
    submitForm() {
    ...
    handleAvatarSuccess(res, file, fileList) {
      ...
      console.log("图片地址", this.ruleForm.cover);
    },
